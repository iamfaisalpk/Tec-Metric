...
const BranchTable: React.FC<BranchTableProps> = ({
    ...
    return (
        <div className="relative">
            ...
            <button
                onClick={onAdd}
                className="fixed top-35 right-10 z-50 flex flex-col items-center gap-1 px-4 py-5 cursor-pointer bg-primary text-white rounded-xl font-medium hover:bg-blue-700 transition-colors shadow-lg"
                title="Add Branch"
            >
                <Building2 className="w-8 h-8" />
            </button>
            <span className=' text-primary font-bold'>Add Branch</span>
