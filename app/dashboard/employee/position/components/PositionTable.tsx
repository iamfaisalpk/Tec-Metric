...
const PositionTable: React.FC<PositionTableProps> = ({
    ...
    return (
        <div className="relative">
            {/* Add Position Button - Top Right Corner */}
            <div className="flex flex-col items-end mb-3">
                <div className="flex flex-col items-center">
                    ...
                    <span className="text-primary font-bold text-center">Add Position</span>
                </div>
            </div>
                            ...
                            {loading ? (
                                ...
                                positions.map((position, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-4 text-text">{position.code}</td>
                                        <td className="px-4 py-4 text-text">{getDepartmentName(position.departmentId)}</td>
                                        <td className="px-4 py-4 text-gray-600">
                                            {new Date(position.createdAt).toLocaleDateString('en-GB')}
                                        </td>
                                        <td className="px-4 py-4 text-gray-600">
                                            {position.updatedAt ? new Date(position.updatedAt).toLocaleDateString('en-GB') : 'N/A'}
                                        </td>
                                        <td className="px-4 py-4">
                                            <PositionActions position={position} onEdit={onEdit} onDelete={onDelete} />
                                        </td>
                                    </motion.tr>
                                ))
                            )}
