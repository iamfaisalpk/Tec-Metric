...
const PositionTable: React.FC<PositionTableProps> = ({
    ...
    const getDepartmentName = useCallback(
        (departmentId: string) => departmentMap.get(departmentId) || 'Unknown Department',
        [departmentMap]
    );
        ...
        <div className="relative">
            ...
            <div className="flex justify-end mb-3">
                <div className="flex flex-col items-center">
                    ...
                    <span className="text-primary font-bold mt-1">Add Position</span>
                </div>
            </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        <thead className="bg-formbg">
                            <tr>
                                {['No.', 'Position Name', 'Position Code', 'Department Name', 'Created Date', 'Updated Date', 'Action'].map(
                                    (h, idx) => (
                                        <th
                                            key={h}
                        ...
                        <tbody className="bg-white divide-y divide-gray-100">
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan={7} className="text-center py-16 text-gray-500 text-lg font-medium">
                                        No positions found.
                                    </td>
                                </tr>
                            ) : (
                                formattedPositions.map((pos, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-4 text-text font-medium">{pos.code}</td>
                                ...
                                {pageNumbers.map((p) => (
                                    <motion.button
                                        ...
                                        className={`w-10 h-10 rounded-lg text-sm font-semibold transition-all ${p === pagination.page
                                                ...
                                                : 'border border-gray-300 hover:bg-gray-50 text-text'
                                            }`}
                                    >
                                        {p}
                                    </motion.button>
