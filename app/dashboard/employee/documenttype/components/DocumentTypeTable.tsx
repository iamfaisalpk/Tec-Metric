                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                >
                                                    {docType.name.slice(0, 2).toUpperCase()}
                                                </motion.div>
                                                <span className="font-medium text-text">{docType.name}</span>
                                            </div>
                                        </td>
                                        <td className="px-4 py-4 text-text">{docType.code}</td>
                                        <td className="px-4 py-4 text-text">{docType.departmentName}</td>
                                        <td className="px-4 py-4 text-gray-600">
                                            {new Date(docType.createdAt).toLocaleDateString('en-GB')}
                                        </td>
                                        <td className="px-4 py-4 text-gray-600">
                                            {docType.updatedAt ? new Date(docType.updatedAt).toLocaleDateString('en-GB') : 'N/A'}
                                        </td>
                                        <td className="px-4 py-4">
